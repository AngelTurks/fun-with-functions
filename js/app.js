...
function multiply(a, b) { //eslint-disable-line
  let multiplied = a * b;
  let str = `The product of ${a} and ${b} is ${multiplied}.`;
  return [multiplied, str];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let str = `${sumArr.join(',')} was passed in as an array of numbers, and ${sum} is their sum.`;
  return [sum, str];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let str = `The numbers ${multArr.join(',')} have a product of ${product}.`;
  return [product, str];
}
